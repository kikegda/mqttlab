#THIS IS THE PUBLISHER CODE FOR EXERCISE 8 - Scenario 1: QoS = 0
import time
...
messages = [
    ("test/qos/scenario1", "Message 1 with QoS=0", 0),
]

print("="*50)
print("Publisher initialized for EXERCISE 8 - Scenario 1")
print("Publishing with QoS = 0")
print("="*50)
